                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <!-- PAGE CONTENT BEGINS -->
                                            <form id="forminsert" action="/admin/building/insert" method="POST">
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    <div>
                                                ...
                                                <div class="col-sm-12">
                                                 ...
                                                 <button class="pull-left" id="btnThemToaNha" type="submit" title="Thêm Toà Nhà" class="btn btn-sucess btn-info btn-bold">
											 		Thêm Toà Nhà
										     	</button>
